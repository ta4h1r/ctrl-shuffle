...
import TagsFieldSelect from '../fields/TagsFieldSelect';
import SwitchChatNav from '../switches/SwitchChatNav'

const useStyles = makeStyles((theme) => ({
  root: {
    flexGrow: 1,
    maxWidth: 752,
    borderStyle: "solid", borderColor: "blue", borderWidth: "0px"
  },
  addNewTextField: {
    display: 'flex',
    flewGrow: 1,
      ...
      return (
        <ListItem key={`${category}-no-${index}`}>
          ...
          <ListItemSecondaryAction>
            <Tooltip arrow title="Remove active tag - the robot will not navigate to this location">
              <span>
    ...
    <div className={classes.root}>
      ...
      <Grid item xs={12} md={12}>
        <Typography variant="h6" className={classes.title}>
          ...
          <SwitchChatNav botProps={botProps} />
